...
const port = '6143';
const inputName = "rest-geojson-in";
const path = `/geoevent/rest/receiver/${args.input}`;
//const logFilepath = `/home/ec2-user/nodejs/dataGenerator/httpReceiver/single/logs/pointslog_${tracks}.csv`
